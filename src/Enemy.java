...
public class Enemy 
{
	...
	public Enemy(int type, int rank)
	{
		...
		{	
			...
			if (rank == 1) { speed = 3; r = 10; health = 3;}
			if (rank == 2) { speed = 2; r = 20; health = 5;}
			if (rank == 3) { speed = 1.5; r = 25; health = 7;}
			if (rank == 4) { speed = 1.5; r = 30; health = 8;}
		}
		...
		if (type == 3)
		{
			...
			if (rank == 1) { speed = 8; r = 15; health = 2;}
			if (rank == 2) { speed = 7; r = 20; health = 3;}
			if (rank == 3) { speed = 6; r = 25; health = 4;}
			if (rank == 4) { speed = 5; r = 30; health = 5;}
		}
